...
<button class="btn btn-info" onclick="if($('#search_bar_form>input').val()) $('#search_bar_form').submit();" type="submit">width="16" height="16" fill="currentColor" viewBox="0 0 512 512" style="
    margin-top: 4px;
    margin-right: 2px;  Search</button>
</form>
</div>
</div>
</nav>

...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      <li class="nav-item">
        <a class="nav-link" href="/${cur}:/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" fill="currentColor" viewBox="0 0 576 512" style="margin-bottom: 3px;" ><path d="M280.37 148.26L96 300.11V464a16 16 0 0 0 16 16l112.06-.29a16 16 0 0 0 15.92-16V368a16 16 0 0 1 16-16h64a16 16 0 0 1 16 16v95.64a16 16 0 0 0 16 16.05L464 480a16 16 0 0 0 16-16V300L295.67 148.26a12.19 12.19 0 0 0-15.3 0zM571.6 251.47L488 182.56V44.05a12 12 0 0 0-12-12h-56a12 12 0 0 0-12 12v72.61L318.47 43a48 48 0 0 0-61 0L4.34 251.47a12 12 0 0 0-1.6 16.9l25.5 31A12 12 0 0 0 45.15 301l235.22-193.74a12.19 12.19 0 0 1 15.3 0L530.9 301a12 12 0 0 0 16.9-1.6l25.5-31a12 12 0 0 0-1.7-16.93z"></path></svg>
        <span></span> Home</a>
      </li>`;
    ...
    html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" style="margin-bottom: 2px;" class="bi bi-hdd-rack-fill" viewBox="0 0 16 16">
...
</svg><span></span> Disk List</a><div class="dropdown-menu" aria-labelledby="navbarDropdown">`;
...
<button class="btn btn-info d-flex" onclick="if($('#search_bar_form>input').val()) $('#search_bar_form').submit();" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 512 512" style="margin-top: 4px;margin-right: 4px;" viewBox="0 0 512 512"><path d="M500.3 443.7l-119.7-119.7c27.22-40.41 40.65-90.9 33.46-144.7C401.8 87.79 326.8 13.32 235.2 1.723C99.01-15.51-15.51 99.01 1.724 235.2c11.6 91.64 86.08 166.7 177.6 178.9c53.8 7.189 104.3-6.236 144.7-33.46l119.7 119.7c15.62 15.62 40.95 15.62 56.57 0C515.9 484.7 515.9 459.3 500.3 443.7zM79.1 208c0-70.58 57.42-128 128-128s128 57.42 128 128c0 70.58-57.42 128-128 128S79.1 278.6 79.1 208z"/></svg>  Search</button>
</form>
</div>
</div>
</nav>
...
function append_files_to_list(path, files) {
    ...
    for (i in files) {
        ...
        if (item['mimeType'] == 'application/vnd.google-apps.folder') {
            ...
            } else if ("|html|php|css|go|java|js|json|txt|py|sh|".indexOf(`|${ext}|`) >= 0) {
            ...
            } else if ("|bmp|jpg|jpeg|webp|png|gif|".indexOf(`|${ext}|`) >= 0) {
            ...
            } else if ("|m4a|mp3|flac|wav|ogg|aac|alac|opus|wav|".indexOf(`|${ext}|`) >= 0) {
...
function append_search_result_to_list(files) {
    ...
    for (i in files) {
        ...
        if (item['mimeType'] == 'application/vnd.google-apps.folder') {
            ...
            if ("|html|php|css|go|java|js|json|txt|sh|py|md|mp4|webm|avi|bmp|jpg|jpeg|webp|png|gif|m4a|mp3|flac|wav|ogg|aac|alac|opus|wav|mpg|mpeg|mkv|rm|rmvb|mov|wmv|asf|ts|flv|".indexOf(`|${ext}|`) >= 0) {
                p += "?a=view";
                c += " view";
            }
...
function file(path) {
    ...
    if ("|html|php|css|go|java|js|json|txt|sh|py|md|".indexOf(`|${ext}|`) >= 0) {
    ...
    if ("|m4a|mp3|flac|wav|ogg|aac|alac|opus|wav|".indexOf(`|${ext}|`) >= 0) {
